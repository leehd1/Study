                ...
                <div class="col-lg-6 offset-lg-3 d-flex">
                    <ul class="pagination mx-auto">
                     <%
                        ...
                        %>
                        <li class="page-item">
                            <a class="page-link" href="./notice.bo?pageNum=<%=startPage-pageBlock%>" aria-label="Previous">
                        ...
                        %>
                        <li class="page-item">
                        	<a class="page-link" href="./notice.bo?pageNum=<%=i%>"><%=i %></a>
                        </li>
                        <%
							}
						...
						%>
                        <li class="page-item">
                            <a class="page-link" href="./notice.bo?pageNum=<%=startPage+pageBlock%>" aria-label="Next">
                                <span aria-hidden="true">»</span>
