...
public class PackageList implements Action {
    ...
    public ActionMove execution(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // 페이징에 필요한 변수 설정
        int totalRecord = dao.getPackageListCount(); // 전체 레코드의 수
        ...
        ArrayList<PackageVO> PackageList = dao.getPackageList(pagingVO);
