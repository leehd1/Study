...
$(function() {
	...
	function winopen() {
		...
		window.open("${contextpath}/review/winopen.jsp?id="+fid, "","top=300,left=800,width=800,height=600");
	}
</script>
<style type="text/css">
.starR1{
...
<section role="main" style="margin-top: 10em;">
    <div class="container">
        <h1 class="h2 mt-2 mb-2 pb-2 border-bottom">후기 작성</h1>
        <div class="d-flex align-items-center p-3 my-3 rounded shadow border-bottom border-right">
            
            <div class="card card-body">
                <form action="${contextpath}/spboardinsert.bo" method="post">
                    
                    <div class="form-group">
                        <label for="subject">제목</label>
                        <input type="text" class="form-control" name="sptitle" id="sptitle">
                    </div>
                   	<label for="subject">다녀온 패키지</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="sppackage" id="sppackage" readonly="readonly">
                        <div class="input-group-append">
                        <button class="btn btn-secondary" type="button" id="button-addon2" onclick="winopen()">다녀온 여행지 검색</button>
                        </div>
                    </div>
                    <div class="form-group">
                    <label>별점주기</label>
                    ...
                    <div class="form-group">
                    	...
                    	<input type="text" class="form-control" name="spsimple_content" id="spsimple_content">
                    </div>
                    <div class="form-group">
                        <label for="p_content">내용</label>
                        <div class="input-group">
						<textarea class="form-control" id="p_content" name = "spcontent"></textarea>
							<script type="text/javascript">
                    ...
                    <input type="hidden" id="package_total_no" name="package_total_no">
                </form>
            </div>
        </div>
    </div>
