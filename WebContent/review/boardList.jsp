...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	List<packspboardDTO> list=(List<packspboardDTO>)request.getAttribute("boardList");
            ...
            <div class="col-lg-6 offset-lg-3 d-flex">
                ...
                <%
                   if(count != 0){
                        ...
                        %>
                    <li class="page-item">
                        <a class="page-link" href="./boardList.bo?pageNum=<%=startPage-pageBlock%>" aria-label="Previous">
                    ...
                    %>
                    <li class="page-item">
                        <a class="page-link" href="./boardList.bo?pageNum=<%=i%>"><%=i%></a>
                    </li>
                    <%
							}
					...
					%>
                    <li class="page-item">
                        <a class="page-link" href="./boardList.bo?pageNum=<%=startPage+pageBlock%>" aria-label="Next">
                            <span aria-hidden="true">»</span>
